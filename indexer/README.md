...
<div align="center">
  <a href="https://github.com/furyanprotocol/v4-chain/actions/workflows/indexer-build-test-coverage.yml?query=branch%3Amain" style="text-decoration:none;">
    <img src="https://github.com/furyanprotocol/v4-chain/actions/workflows/indexer-build-test-coverage.yml/badge.svg?branch=main" />
  </a>
</div>
...
```
- Update `package.json` name to `@furyaprotocol-indexer/<package-name>`, update the `README.md`, and run `pnpm i` to install dependencies.
...
follow the instructions [here](https://github.com/furyaprotocol/v4#running-the-chain-locally).
...
We use [Terraform](https://github.com/furyaprotocol/v4-infrastructure) to describe our infrastructure. On merging to
...
# staging
wscli connect wss://indexer.v4staging.furya.exchange/v4/ws
```
