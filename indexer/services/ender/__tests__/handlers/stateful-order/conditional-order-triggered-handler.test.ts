...
import { ORDER_FLAG_CONDITIONAL } from '@furyaprotocol-indexer/v4-proto-parser';
import { ConditionalOrderTriggeredHandler } from '../../../src/handlers/stateful-order/conditional-order-triggered-handler';
import { defaultPerpetualMarket } from '@furyaprotocol-indexer/postgres/build/__tests__/helpers/constants';
  ...
  describe('getParallelizationIds', () => {
    it('returns the correct parallelization ids', () => {
      ...
      const indexerTendermintEvent: IndexerTendermintEvent = createIndexerTendermintEvent(
        FuryaIndexerSubtypes.STATEFUL_ORDER,
