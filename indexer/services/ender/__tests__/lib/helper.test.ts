import { IndexerTendermintEvent, IndexerTendermintEvent_BlockEvent } from '@furyaprotocol-indexer/v4-protos';
import { ParseMessageError } from '@furyaprotocol-indexer/base';
