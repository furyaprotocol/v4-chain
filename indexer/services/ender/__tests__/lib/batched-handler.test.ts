import { IndexerTendermintBlock, IndexerTendermintEvent } from '@furyaprotocol-indexer/v4-protos';
import { Handler } from '../../src/handlers/handler';
import { BatchedHandlers } from '../../src/lib/batched-handlers';
import { ConsolidatedKafkaEvent, FuryaIndexerSubtypes, EventMessage } from '../../src/lib/types';
import {
  defaultHeight,
  defaultTime,
  defaultTxHash,
