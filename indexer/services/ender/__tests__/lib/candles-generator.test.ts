...
import { CANDLES_WEBSOCKET_MESSAGE_VERSION } from '@furyaprotocol-indexer/kafka';
import {
...
import { CandleMessage, CandleMessage_Resolution } from '@furyaprotocol-indexer/v4-protos';
