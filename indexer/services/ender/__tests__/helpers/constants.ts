import { SUBACCOUNTS_WEBSOCKET_MESSAGE_VERSION } from '@furyaprotocol-indexer/kafka';
import { testConstants, TradeContent, TradeType } from '@furyaprotocol-indexer/postgres';
import {
  bigIntToBytes,
