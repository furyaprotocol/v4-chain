CREATE OR REPLACE FUNCTION furya_get_weighted_average(first_price numeric, first_weight numeric, second_price numeric, second_weight numeric) RETURNS numeric AS $$
/**
...
*/
BEGIN
    RETURN furya_trim_scale((coalesce(first_price, 0::numeric) * first_weight +
