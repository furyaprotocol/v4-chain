CREATE OR REPLACE FUNCTION furya_protocol_condition_type_to_order_type(condition_type jsonb) RETURNS text AS $$
/**
  Converts the 'ConditionType' enum from the IndexerOrder protobuf (https://github.com/furyanprotocol/v4-chain/blob/9ed26bd/proto/furyaprotocol/indexer/protocol/v1/clob.proto#L130)
