...
import { ComplianceClientResponse } from '@furyaprotocol-indexer/compliance';
...
describe('update-compliance-data', () => {
  ...
  it('succeeds with updating multiple addresses, with failures', async () => {
    ...
    const addressWithComplianceError: string = 'furya1gem4xs643fjhaqvphrvv0adpg4435j7xx9pp4z';
