...
export class MsgClientImpl implements Msg {
  ...
  setLimitParams(request: MsgSetLimitParams): Promise<MsgSetLimitParamsResponse> {
    ...
    const promise = this.rpc.request("furyaprotocol.ratelimit.Msg", "SetLimitParams", data);
  ...
  deleteLimitParams(request: MsgDeleteLimitParams): Promise<MsgDeleteLimitParamsResponse> {
    ...
    const promise = this.rpc.request("furyaprotocol.ratelimit.Msg", "DeleteLimitParams", data);
