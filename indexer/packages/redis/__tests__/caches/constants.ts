import { IsoString, OrderTable, SubaccountTable } from '@furyaprotocol-indexer/postgres';
...
export const address: string = 'furyaprotocol174e000tqwvszgjxs7yaj844e0m9s6f0m45ws7q';
