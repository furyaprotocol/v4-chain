import { bytesToBigInt } from '@furyaprotocol-indexer/v4-proto-parser';
import {
  IndexerOrder,
  IndexerOrder_Side,
...
export function getGoodTilBlockTime(order: IndexerOrder): IsoString | undefined {
  if (order.goodTilBlockTime !== undefined) {
    ...
    // Reference:
    // https://github.com/furyaprotocol/v4/blob/main/proto/furyaprotocol/clob/order.proto#L138-L144
