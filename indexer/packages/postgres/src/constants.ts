import { CandleMessage_Resolution, ClobPairStatus } from '@furyaprotocol-indexer/v4-protos';
...
// Sourced from protocol https://github.com/furyaprotocol/v4/blob/main/lib/constants.go#L6
