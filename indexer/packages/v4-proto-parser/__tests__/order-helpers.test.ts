import { IndexerOrderId } from '@furyaprotocol-indexer/v4-protos';
...
describe('getOrderIdHash', () => {
  ...
  // https://github.com/furyaprotocol/v4/blob/311411a3ce92230d4866a7c4abb1422fbc4ef3b9/indexer/off_chain_updates/off_chain_updates_test.go#L278-L299
