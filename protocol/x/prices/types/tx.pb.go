...
// source: furyaprotocol/prices/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateOracleMarket)(nil), "furyaprotocol.prices.MsgCreateOracleMarket")
	proto.RegisterType((*MsgCreateOracleMarketResponse)(nil), "furyaprotocol.prices.MsgCreateOracleMarketResponse")
	proto.RegisterType((*MsgUpdateMarketPrices)(nil), "furyaprotocol.prices.MsgUpdateMarketPrices")
	proto.RegisterType((*MsgUpdateMarketPrices_MarketPrice)(nil), "furyaprotocol.prices.MsgUpdateMarketPrices.MarketPrice")
	proto.RegisterType((*MsgUpdateMarketPricesResponse)(nil), "furyaprotocol.prices.MsgUpdateMarketPricesResponse")
	proto.RegisterType((*MsgUpdateMarketParam)(nil), "furyaprotocol.prices.MsgUpdateMarketParam")
	proto.RegisterType((*MsgUpdateMarketParamResponse)(nil), "furyaprotocol.prices.MsgUpdateMarketParamResponse")
}

func init() { proto.RegisterFile("furyaprotocol/prices/tx.proto", fileDescriptor_70ca248e15be37c4) }
...
func (c *msgClient) UpdateMarketPrices(ctx context.Context, in *MsgUpdateMarketPrices, opts ...grpc.CallOption) (*MsgUpdateMarketPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.prices.Msg/UpdateMarketPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CreateOracleMarket(ctx context.Context, in *MsgCreateOracleMarket, opts ...grpc.CallOption) (*MsgCreateOracleMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.prices.Msg/CreateOracleMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateMarketParam(ctx context.Context, in *MsgUpdateMarketParam, opts ...grpc.CallOption) (*MsgUpdateMarketParamResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.prices.Msg/UpdateMarketParam", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateMarketPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.prices.Msg/UpdateMarketPrices",
	}
...
func _Msg_CreateOracleMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.prices.Msg/CreateOracleMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateMarketParam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.prices.Msg/UpdateMarketParam",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.prices.Msg",
	...
	Metadata: "furyaprotocol/prices/tx.proto",
}
