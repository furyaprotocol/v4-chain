...
// source: furyaprotocol/prices/market_price.proto
...
func init() {
	proto.RegisterType((*MarketPrice)(nil), "furyaprotocol.prices.MarketPrice")
}

func init() {
	proto.RegisterFile("furyaprotocol/prices/market_price.proto", fileDescriptor_dfe320bc057cd5ae)
}
