...
// source: furyaprotocol/prices/market_param.proto
...
func init() {
	proto.RegisterType((*MarketParam)(nil), "furyaprotocol.prices.MarketParam")
}

func init() {
	proto.RegisterFile("furyaprotocol/prices/market_param.proto", fileDescriptor_39174a2dba54f799)
}
