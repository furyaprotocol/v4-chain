...
// source: furyaprotocol/prices/query.proto
...
func init() {
	proto.RegisterType((*QueryMarketPriceRequest)(nil), "furyaprotocol.prices.QueryMarketPriceRequest")
	proto.RegisterType((*QueryMarketPriceResponse)(nil), "furyaprotocol.prices.QueryMarketPriceResponse")
	proto.RegisterType((*QueryAllMarketPricesRequest)(nil), "furyaprotocol.prices.QueryAllMarketPricesRequest")
	proto.RegisterType((*QueryAllMarketPricesResponse)(nil), "furyaprotocol.prices.QueryAllMarketPricesResponse")
	proto.RegisterType((*QueryMarketParamRequest)(nil), "furyaprotocol.prices.QueryMarketParamRequest")
	proto.RegisterType((*QueryMarketParamResponse)(nil), "furyaprotocol.prices.QueryMarketParamResponse")
	proto.RegisterType((*QueryAllMarketParamsRequest)(nil), "furyaprotocol.prices.QueryAllMarketParamsRequest")
	proto.RegisterType((*QueryAllMarketParamsResponse)(nil), "furyaprotocol.prices.QueryAllMarketParamsResponse")
}

func init() { proto.RegisterFile("furyaprotocol/prices/query.proto", fileDescriptor_c306b315383f34f4) }
...
func (c *queryClient) MarketPrice(ctx context.Context, in *QueryMarketPriceRequest, opts ...grpc.CallOption) (*QueryMarketPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.prices.Query/MarketPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllMarketPrices(ctx context.Context, in *QueryAllMarketPricesRequest, opts ...grpc.CallOption) (*QueryAllMarketPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.prices.Query/AllMarketPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) MarketParam(ctx context.Context, in *QueryMarketParamRequest, opts ...grpc.CallOption) (*QueryMarketParamResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.prices.Query/MarketParam", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllMarketParams(ctx context.Context, in *QueryAllMarketParamsRequest, opts ...grpc.CallOption) (*QueryAllMarketParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.prices.Query/AllMarketParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_MarketPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.prices.Query/MarketPrice",
	}
...
func _Query_AllMarketPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.prices.Query/AllMarketPrices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_MarketParam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.prices.Query/MarketParam",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AllMarketParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.prices.Query/AllMarketParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.prices.Query",
	...
	Metadata: "furyaprotocol/prices/query.proto",
}
