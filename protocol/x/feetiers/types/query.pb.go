...
// source: furyaprotocol/feetiers/query.proto
...
func init() {
	proto.RegisterType((*QueryPerpetualFeeParamsRequest)(nil), "furyaprotocol.feetiers.QueryPerpetualFeeParamsRequest")
	proto.RegisterType((*QueryPerpetualFeeParamsResponse)(nil), "furyaprotocol.feetiers.QueryPerpetualFeeParamsResponse")
	proto.RegisterType((*QueryUserFeeTierRequest)(nil), "furyaprotocol.feetiers.QueryUserFeeTierRequest")
	proto.RegisterType((*QueryUserFeeTierResponse)(nil), "furyaprotocol.feetiers.QueryUserFeeTierResponse")
}

func init() { proto.RegisterFile("furyaprotocol/feetiers/query.proto", fileDescriptor_f31456045d64644f) }
...
func (c *queryClient) PerpetualFeeParams(ctx context.Context, in *QueryPerpetualFeeParamsRequest, opts ...grpc.CallOption) (*QueryPerpetualFeeParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.feetiers.Query/PerpetualFeeParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) UserFeeTier(ctx context.Context, in *QueryUserFeeTierRequest, opts ...grpc.CallOption) (*QueryUserFeeTierResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.feetiers.Query/UserFeeTier", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_PerpetualFeeParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.feetiers.Query/PerpetualFeeParams",
	}
...
func _Query_UserFeeTier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.feetiers.Query/UserFeeTier",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.feetiers.Query",
	...
	Metadata: "furyaprotocol/feetiers/query.proto",
}
