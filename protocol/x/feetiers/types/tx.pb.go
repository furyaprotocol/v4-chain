...
// source: furyaprotocol/feetiers/tx.proto
...
func init() {
	proto.RegisterType((*MsgUpdatePerpetualFeeParams)(nil), "furyaprotocol.feetiers.MsgUpdatePerpetualFeeParams")
	proto.RegisterType((*MsgUpdatePerpetualFeeParamsResponse)(nil), "furyaprotocol.feetiers.MsgUpdatePerpetualFeeParamsResponse")
}

func init() { proto.RegisterFile("furyaprotocol/feetiers/tx.proto", fileDescriptor_caa74a3b986b7fd9) }
...
func (c *msgClient) UpdatePerpetualFeeParams(ctx context.Context, in *MsgUpdatePerpetualFeeParams, opts ...grpc.CallOption) (*MsgUpdatePerpetualFeeParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.feetiers.Msg/UpdatePerpetualFeeParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdatePerpetualFeeParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.feetiers.Msg/UpdatePerpetualFeeParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.feetiers.Msg",
	...
	Metadata: "furyaprotocol/feetiers/tx.proto",
}
