...
// source: furyaprotocol/rewards/reward_share.proto
...
type RewardShare struct {
	...
	Weight  github_com_furyaprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=weight,proto3,customtype=github.com/furyanprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"weight"`
}
...
func init() {
	proto.RegisterType((*RewardShare)(nil), "furyaprotocol.rewards.RewardShare")
}

func init() {
	proto.RegisterFile("furyaprotocol/rewards/reward_share.proto", fileDescriptor_a9d4fef3ba0acce6)
}
