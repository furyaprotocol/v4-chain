...
// source: furyaprotocol/bridge/params.proto
...
func init() {
	proto.RegisterType((*EventParams)(nil), "furyaprotocol.bridge.EventParams")
	proto.RegisterType((*ProposeParams)(nil), "furyaprotocol.bridge.ProposeParams")
	proto.RegisterType((*SafetyParams)(nil), "furyaprotocol.bridge.SafetyParams")
}

func init() { proto.RegisterFile("furyaprotocol/bridge/params.proto", fileDescriptor_29afb5e8a05168cd) }
