...
// source: furyaprotocol/bridge/bridge_event_info.proto
...
func init() {
	proto.RegisterType((*BridgeEventInfo)(nil), "furyaprotocol.bridge.BridgeEventInfo")
}

func init() {
	proto.RegisterFile("furyaprotocol/bridge/bridge_event_info.proto", fileDescriptor_ca20c815789f7707)
}
