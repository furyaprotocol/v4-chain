...
// source: furyaprotocol/bridge/bridge_event.proto
...
func init() {
	proto.RegisterType((*BridgeEvent)(nil), "furyaprotocol.bridge.BridgeEvent")
}

func init() {
	proto.RegisterFile("furyaprotocol/bridge/bridge_event.proto", fileDescriptor_d8b4b572ecddaf6f)
}
