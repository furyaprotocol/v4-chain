...
// source: furyaprotocol/ratelimit/capacity.proto
...
type DenomCapacity struct {
	...
	// `LimitParams`.
	CapacityList []github_com_furyaprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,rep,name=capacity_list,json=capacityList,proto3,customtype=github.com/furyanprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"capacity_list"`
}
...
func init() {
	proto.RegisterType((*DenomCapacity)(nil), "furyaprotocol.ratelimit.DenomCapacity")
}

func init() {
	proto.RegisterFile("furyaprotocol/ratelimit/capacity.proto", fileDescriptor_1d7e1de92ba2a318)
}
...
func (m *DenomCapacity) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var v github_com_furyaprotocol_v4_chain_protocol_dtypes.SerializableInt
