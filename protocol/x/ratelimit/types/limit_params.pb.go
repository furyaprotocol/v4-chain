...
// source: furyaprotocol/ratelimit/limit_params.proto
...
type Limiter struct {
	...
	BaselineMinimum github_com_furyaprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=baseline_minimum,json=baselineMinimum,proto3,customtype=github.com/furyanprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"baseline_minimum"`
...
func init() {
	proto.RegisterType((*LimitParams)(nil), "furyaprotocol.ratelimit.LimitParams")
	proto.RegisterType((*Limiter)(nil), "furyaprotocol.ratelimit.Limiter")
}

func init() {
	proto.RegisterFile("furyaprotocol/ratelimit/limit_params.proto", fileDescriptor_b795558e1de1468a)
}
