...
// source: furyaprotocol/ratelimit/tx.proto
...
func init() {
	proto.RegisterType((*MsgSetLimitParams)(nil), "furyaprotocol.ratelimit.MsgSetLimitParams")
	proto.RegisterType((*MsgSetLimitParamsResponse)(nil), "furyaprotocol.ratelimit.MsgSetLimitParamsResponse")
	proto.RegisterType((*MsgDeleteLimitParams)(nil), "furyaprotocol.ratelimit.MsgDeleteLimitParams")
	proto.RegisterType((*MsgDeleteLimitParamsResponse)(nil), "furyaprotocol.ratelimit.MsgDeleteLimitParamsResponse")
}

func init() { proto.RegisterFile("furyaprotocol/ratelimit/tx.proto", fileDescriptor_3c12b4609ad9be85) }
...
func (c *msgClient) SetLimitParams(ctx context.Context, in *MsgSetLimitParams, opts ...grpc.CallOption) (*MsgSetLimitParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.ratelimit.Msg/SetLimitParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteLimitParams(ctx context.Context, in *MsgDeleteLimitParams, opts ...grpc.CallOption) (*MsgDeleteLimitParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.ratelimit.Msg/DeleteLimitParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetLimitParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.ratelimit.Msg/SetLimitParams",
	}
...
func _Msg_DeleteLimitParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.ratelimit.Msg/DeleteLimitParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.ratelimit.Msg",
	...
	Metadata: "furyaprotocol/ratelimit/tx.proto",
}
