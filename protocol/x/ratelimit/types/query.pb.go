...
// source: furyaprotocol/ratelimit/query.proto
...
type CapacityResult struct {
	...
	Capacity  github_com_furyaprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=capacity,proto3,customtype=github.com/furyanprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"capacity"`
}
...
func init() {
	proto.RegisterType((*ListLimitParamsRequest)(nil), "furyaprotocol.ratelimit.ListLimitParamsRequest")
	proto.RegisterType((*ListLimitParamsResponse)(nil), "furyaprotocol.ratelimit.ListLimitParamsResponse")
	proto.RegisterType((*QueryCapacityByDenomRequest)(nil), "furyaprotocol.ratelimit.QueryCapacityByDenomRequest")
	proto.RegisterType((*CapacityResult)(nil), "furyaprotocol.ratelimit.CapacityResult")
	proto.RegisterType((*QueryCapacityByDenomResponse)(nil), "furyaprotocol.ratelimit.QueryCapacityByDenomResponse")
}

func init() {
	proto.RegisterFile("furyaprotocol/ratelimit/query.proto", fileDescriptor_f2e2dd1cb27aa65a)
}
...
func (c *queryClient) ListLimitParams(ctx context.Context, in *ListLimitParamsRequest, opts ...grpc.CallOption) (*ListLimitParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.ratelimit.Query/ListLimitParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CapacityByDenom(ctx context.Context, in *QueryCapacityByDenomRequest, opts ...grpc.CallOption) (*QueryCapacityByDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.ratelimit.Query/CapacityByDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ListLimitParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.ratelimit.Query/ListLimitParams",
	}
...
func _Query_CapacityByDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.ratelimit.Query/CapacityByDenom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.ratelimit.Query",
	...
	Metadata: "furyaprotocol/ratelimit/query.proto",
}
