...
// source: furyaprotocol/subaccounts/perpetual_position.proto
...
func init() {
	proto.RegisterType((*PerpetualPosition)(nil), "furyaprotocol.subaccounts.PerpetualPosition")
}

func init() {
	proto.RegisterFile("furyaprotocol/subaccounts/perpetual_position.proto", fileDescriptor_e659838f8a8f5498)
}
