...
// source: furyaprotocol/subaccounts/asset_position.proto
...
func init() {
	proto.RegisterType((*AssetPosition)(nil), "furyaprotocol.subaccounts.AssetPosition")
}

func init() {
	proto.RegisterFile("furyaprotocol/subaccounts/asset_position.proto", fileDescriptor_21b5b4cb0c7ef07c)
}
