...
// source: furyaprotocol/clob/process_proposer_matches_events.proto
...
func init() {
	proto.RegisterType((*ProcessProposerMatchesEvents)(nil), "furyaprotocol.clob.ProcessProposerMatchesEvents")
}

func init() {
	proto.RegisterFile("furyaprotocol/clob/process_proposer_matches_events.proto", fileDescriptor_4626e94e6961a770)
}
