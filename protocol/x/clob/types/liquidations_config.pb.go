...
// source: furyaprotocol/clob/liquidations_config.proto
...
func init() {
	proto.RegisterType((*LiquidationsConfig)(nil), "furyaprotocol.clob.LiquidationsConfig")
	proto.RegisterType((*PositionBlockLimits)(nil), "furyaprotocol.clob.PositionBlockLimits")
	proto.RegisterType((*SubaccountBlockLimits)(nil), "furyaprotocol.clob.SubaccountBlockLimits")
	proto.RegisterType((*FillablePriceConfig)(nil), "furyaprotocol.clob.FillablePriceConfig")
}

func init() {
	proto.RegisterFile("furyaprotocol/clob/liquidations_config.proto", fileDescriptor_d11e0d49099a14b4)
}
