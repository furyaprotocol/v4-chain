...
// source: furyaprotocol/clob/order_removals.proto
...
type OrderRemoval struct {
	...
	RemovalReason OrderRemoval_RemovalReason `protobuf:"varint,2,opt,name=removal_reason,json=removalReason,proto3,enum=furyaprotocol.clob.OrderRemoval_RemovalReason" json:"removal_reason,omitempty"`
}
...
func init() {
	proto.RegisterEnum("furyaprotocol.clob.OrderRemoval_RemovalReason", OrderRemoval_RemovalReason_name, OrderRemoval_RemovalReason_value)
	proto.RegisterType((*OrderRemoval)(nil), "furyaprotocol.clob.OrderRemoval")
}

func init() {
	proto.RegisterFile("furyaprotocol/clob/order_removals.proto", fileDescriptor_60fa12f781955c9f)
}
