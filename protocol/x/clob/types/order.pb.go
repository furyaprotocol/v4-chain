...
// source: furyaprotocol/clob/order.proto
...
import (
	...
	types "github.com/furyanprotocol/v4-chain/protocol/x/subaccounts/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type Order struct {
	...
	Side    Order_Side `protobuf:"varint,2,opt,name=side,proto3,enum=furyaprotocol.clob.Order_Side" json:"side,omitempty"`
	...
	TimeInForce Order_TimeInForce `protobuf:"varint,7,opt,name=time_in_force,json=timeInForce,proto3,enum=furyaprotocol.clob.Order_TimeInForce" json:"time_in_force,omitempty"`
	...
	ConditionType  Order_ConditionType `protobuf:"varint,10,opt,name=condition_type,json=conditionType,proto3,enum=furyaprotocol.clob.Order_ConditionType" json:"condition_type,omitempty"`
...
func init() {
	proto.RegisterEnum("furyaprotocol.clob.Order_Side", Order_Side_name, Order_Side_value)
	proto.RegisterEnum("furyaprotocol.clob.Order_TimeInForce", Order_TimeInForce_name, Order_TimeInForce_value)
	proto.RegisterEnum("furyaprotocol.clob.Order_ConditionType", Order_ConditionType_name, Order_ConditionType_value)
	proto.RegisterType((*OrderId)(nil), "furyaprotocol.clob.OrderId")
	proto.RegisterType((*OrdersFilledDuringLatestBlock)(nil), "furyaprotocol.clob.OrdersFilledDuringLatestBlock")
	proto.RegisterType((*PotentiallyPrunableOrders)(nil), "furyaprotocol.clob.PotentiallyPrunableOrders")
	proto.RegisterType((*OrderFillState)(nil), "furyaprotocol.clob.OrderFillState")
	proto.RegisterType((*StatefulOrderTimeSliceValue)(nil), "furyaprotocol.clob.StatefulOrderTimeSliceValue")
	proto.RegisterType((*LongTermOrderPlacement)(nil), "furyaprotocol.clob.LongTermOrderPlacement")
	proto.RegisterType((*ConditionalOrderPlacement)(nil), "furyaprotocol.clob.ConditionalOrderPlacement")
	proto.RegisterType((*Order)(nil), "furyaprotocol.clob.Order")
	proto.RegisterType((*TransactionOrdering)(nil), "furyaprotocol.clob.TransactionOrdering")
}

func init() { proto.RegisterFile("furyaprotocol/clob/order.proto", fileDescriptor_673c6f4faa93736b) }
