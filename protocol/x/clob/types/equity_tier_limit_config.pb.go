...
// source: furyaprotocol/clob/equity_tier_limit_config.proto
...
type EquityTierLimit struct {
	...
	UsdTncRequired github_com_furyaprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,1,opt,name=usd_tnc_required,json=usdTncRequired,proto3,customtype=github.com/furyanprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"usd_tnc_required"`
...
func init() {
	proto.RegisterType((*EquityTierLimitConfiguration)(nil), "furyaprotocol.clob.EquityTierLimitConfiguration")
	proto.RegisterType((*EquityTierLimit)(nil), "furyaprotocol.clob.EquityTierLimit")
}

func init() {
	proto.RegisterFile("furyaprotocol/clob/equity_tier_limit_config.proto", fileDescriptor_eb08cfe6323c23aa)
}
