...
// source: furyaprotocol/clob/operation.proto
...
func init() {
	proto.RegisterType((*Operation)(nil), "furyaprotocol.clob.Operation")
	proto.RegisterType((*InternalOperation)(nil), "furyaprotocol.clob.InternalOperation")
}

func init() { proto.RegisterFile("furyaprotocol/clob/operation.proto", fileDescriptor_5906bab2b2e9b3cf) }
