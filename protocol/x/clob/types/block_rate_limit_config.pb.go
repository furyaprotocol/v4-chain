...
// source: furyaprotocol/clob/block_rate_limit_config.proto
...
func init() {
	proto.RegisterType((*BlockRateLimitConfiguration)(nil), "furyaprotocol.clob.BlockRateLimitConfiguration")
	proto.RegisterType((*MaxPerNBlocksRateLimit)(nil), "furyaprotocol.clob.MaxPerNBlocksRateLimit")
}

func init() {
	proto.RegisterFile("furyaprotocol/clob/block_rate_limit_config.proto", fileDescriptor_0b7d196450032f13)
}
