...
// source: furyaprotocol/blocktime/tx.proto
...
func init() {
	proto.RegisterType((*MsgUpdateDowntimeParams)(nil), "furyaprotocol.blocktime.MsgUpdateDowntimeParams")
	proto.RegisterType((*MsgUpdateDowntimeParamsResponse)(nil), "furyaprotocol.blocktime.MsgUpdateDowntimeParamsResponse")
}

func init() { proto.RegisterFile("furyaprotocol/blocktime/tx.proto", fileDescriptor_4b4afda7c355c8b6) }
...
func (c *msgClient) UpdateDowntimeParams(ctx context.Context, in *MsgUpdateDowntimeParams, opts ...grpc.CallOption) (*MsgUpdateDowntimeParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.blocktime.Msg/UpdateDowntimeParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateDowntimeParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.blocktime.Msg/UpdateDowntimeParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.blocktime.Msg",
	...
	Metadata: "furyaprotocol/blocktime/tx.proto",
}
