...
// source: furyaprotocol/blocktime/blocktime.proto
...
func init() {
	proto.RegisterType((*BlockInfo)(nil), "furyaprotocol.blocktime.BlockInfo")
	proto.RegisterType((*AllDowntimeInfo)(nil), "furyaprotocol.blocktime.AllDowntimeInfo")
	proto.RegisterType((*AllDowntimeInfo_DowntimeInfo)(nil), "furyaprotocol.blocktime.AllDowntimeInfo.DowntimeInfo")
}

func init() {
	proto.RegisterFile("furyaprotocol/blocktime/blocktime.proto", fileDescriptor_7e16363cb4e2638e)
}
