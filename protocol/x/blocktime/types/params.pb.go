...
// source: furyaprotocol/blocktime/params.proto
...
func init() {
	proto.RegisterType((*DowntimeParams)(nil), "furyaprotocol.blocktime.DowntimeParams")
}

func init() {
	proto.RegisterFile("furyaprotocol/blocktime/params.proto", fileDescriptor_d036653b2617e4cf)
}
