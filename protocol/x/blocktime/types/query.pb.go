...
// source: furyaprotocol/blocktime/query.proto
...
func init() {
	proto.RegisterType((*QueryDowntimeParamsRequest)(nil), "furyaprotocol.blocktime.QueryDowntimeParamsRequest")
	proto.RegisterType((*QueryDowntimeParamsResponse)(nil), "furyaprotocol.blocktime.QueryDowntimeParamsResponse")
	proto.RegisterType((*QueryPreviousBlockInfoRequest)(nil), "furyaprotocol.blocktime.QueryPreviousBlockInfoRequest")
	proto.RegisterType((*QueryPreviousBlockInfoResponse)(nil), "furyaprotocol.blocktime.QueryPreviousBlockInfoResponse")
	proto.RegisterType((*QueryAllDowntimeInfoRequest)(nil), "furyaprotocol.blocktime.QueryAllDowntimeInfoRequest")
	proto.RegisterType((*QueryAllDowntimeInfoResponse)(nil), "furyaprotocol.blocktime.QueryAllDowntimeInfoResponse")
}

func init() {
	proto.RegisterFile("furyaprotocol/blocktime/query.proto", fileDescriptor_c6fa5ca81d500c56)
}
...
func (c *queryClient) DowntimeParams(ctx context.Context, in *QueryDowntimeParamsRequest, opts ...grpc.CallOption) (*QueryDowntimeParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.blocktime.Query/DowntimeParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PreviousBlockInfo(ctx context.Context, in *QueryPreviousBlockInfoRequest, opts ...grpc.CallOption) (*QueryPreviousBlockInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.blocktime.Query/PreviousBlockInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllDowntimeInfo(ctx context.Context, in *QueryAllDowntimeInfoRequest, opts ...grpc.CallOption) (*QueryAllDowntimeInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.blocktime.Query/AllDowntimeInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_DowntimeParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.blocktime.Query/DowntimeParams",
	}
...
func _Query_PreviousBlockInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.blocktime.Query/PreviousBlockInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AllDowntimeInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.blocktime.Query/AllDowntimeInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.blocktime.Query",
	...
	Metadata: "furyaprotocol/blocktime/query.proto",
}
