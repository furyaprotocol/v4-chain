...
// source: furyaprotocol/sending/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateTransfer)(nil), "furyaprotocol.sending.MsgCreateTransfer")
	proto.RegisterType((*MsgCreateTransferResponse)(nil), "furyaprotocol.sending.MsgCreateTransferResponse")
	proto.RegisterType((*MsgDepositToSubaccountResponse)(nil), "furyaprotocol.sending.MsgDepositToSubaccountResponse")
	proto.RegisterType((*MsgWithdrawFromSubaccountResponse)(nil), "furyaprotocol.sending.MsgWithdrawFromSubaccountResponse")
	proto.RegisterType((*MsgSendFromModuleToAccountResponse)(nil), "furyaprotocol.sending.MsgSendFromModuleToAccountResponse")
}

func init() { proto.RegisterFile("furyaprotocol/sending/tx.proto", fileDescriptor_056a3cb0feba7dbf) }
...
func (c *msgClient) CreateTransfer(ctx context.Context, in *MsgCreateTransfer, opts ...grpc.CallOption) (*MsgCreateTransferResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.sending.Msg/CreateTransfer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DepositToSubaccount(ctx context.Context, in *MsgDepositToSubaccount, opts ...grpc.CallOption) (*MsgDepositToSubaccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.sending.Msg/DepositToSubaccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawFromSubaccount(ctx context.Context, in *MsgWithdrawFromSubaccount, opts ...grpc.CallOption) (*MsgWithdrawFromSubaccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.sending.Msg/WithdrawFromSubaccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SendFromModuleToAccount(ctx context.Context, in *MsgSendFromModuleToAccount, opts ...grpc.CallOption) (*MsgSendFromModuleToAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.sending.Msg/SendFromModuleToAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.sending.Msg/CreateTransfer",
	}
...
func _Msg_DepositToSubaccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.sending.Msg/DepositToSubaccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_WithdrawFromSubaccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.sending.Msg/WithdrawFromSubaccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SendFromModuleToAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.sending.Msg/SendFromModuleToAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.sending.Msg",
	...
	Metadata: "furyaprotocol/sending/tx.proto",
}
