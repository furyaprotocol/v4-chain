...
// source: furyaprotocol/sending/transfer.proto
...
func init() {
	proto.RegisterType((*Transfer)(nil), "furyaprotocol.sending.Transfer")
	proto.RegisterType((*MsgDepositToSubaccount)(nil), "furyaprotocol.sending.MsgDepositToSubaccount")
	proto.RegisterType((*MsgWithdrawFromSubaccount)(nil), "furyaprotocol.sending.MsgWithdrawFromSubaccount")
	proto.RegisterType((*MsgSendFromModuleToAccount)(nil), "furyaprotocol.sending.MsgSendFromModuleToAccount")
}

func init() {
	proto.RegisterFile("furyaprotocol/sending/transfer.proto", fileDescriptor_6ef1d018df19de71)
}
