...
import (
	...
	"github.com/furyanprotocol/v4-chain/protocol/x/sending"
	sending_keeper "github.com/furyanprotocol/v4-chain/protocol/x/sending/keeper"
...
func TestAppModuleBasic_RegisterGRPCGatewayRoutes(t *testing.T) {
	...
	req, err := http.NewRequest("GET", "/furyaprotocol/sending/", nil)
	require.NoError(t, err)
