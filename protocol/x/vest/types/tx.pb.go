...
// source: furyaprotocol/vest/tx.proto
...
func init() {
	proto.RegisterType((*MsgDeleteVestEntry)(nil), "furyaprotocol.vest.MsgDeleteVestEntry")
	proto.RegisterType((*MsgDeleteVestEntryResponse)(nil), "furyaprotocol.vest.MsgDeleteVestEntryResponse")
	proto.RegisterType((*MsgSetVestEntry)(nil), "furyaprotocol.vest.MsgSetVestEntry")
	proto.RegisterType((*MsgSetVestEntryResponse)(nil), "furyaprotocol.vest.MsgSetVestEntryResponse")
}

func init() { proto.RegisterFile("furyaprotocol/vest/tx.proto", fileDescriptor_e68cfe60566e0fc5) }
...
func (c *msgClient) SetVestEntry(ctx context.Context, in *MsgSetVestEntry, opts ...grpc.CallOption) (*MsgSetVestEntryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.vest.Msg/SetVestEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteVestEntry(ctx context.Context, in *MsgDeleteVestEntry, opts ...grpc.CallOption) (*MsgDeleteVestEntryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.vest.Msg/DeleteVestEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetVestEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.vest.Msg/SetVestEntry",
	}
...
func _Msg_DeleteVestEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.vest.Msg/DeleteVestEntry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.vest.Msg",
	...
	Metadata: "furyaprotocol/vest/tx.proto",
}
