...
// source: furyaprotocol/vest/vest_entry.proto
...
func init() {
	proto.RegisterType((*VestEntry)(nil), "furyaprotocol.vest.VestEntry")
}

func init() {
	proto.RegisterFile("furyaprotocol/vest/vest_entry.proto", fileDescriptor_9d3eb625294a27a6)
}
