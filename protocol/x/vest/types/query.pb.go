...
// source: furyaprotocol/vest/query.proto
...
func init() {
	proto.RegisterType((*QueryVestEntryRequest)(nil), "furyaprotocol.vest.QueryVestEntryRequest")
	proto.RegisterType((*QueryVestEntryResponse)(nil), "furyaprotocol.vest.QueryVestEntryResponse")
}

func init() { proto.RegisterFile("furyaprotocol/vest/query.proto", fileDescriptor_3a660be800e547c7) }
...
func (c *queryClient) VestEntry(ctx context.Context, in *QueryVestEntryRequest, opts ...grpc.CallOption) (*QueryVestEntryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.vest.Query/VestEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_VestEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.vest.Query/VestEntry",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.vest.Query",
	...
	Metadata: "furyaprotocol/vest/query.proto",
}
