...
import (
	...
	"github.com/furyanprotocol/v4-chain/protocol/x/assets"
	assets_keeper "github.com/furyanprotocol/v4-chain/protocol/x/assets/keeper"
...
func TestAppModuleBasic_RegisterGRPCGatewayRoutes(t *testing.T) {
	...
	req, err := http.NewRequest("GET", "/furyaprotocol/assets", nil)
	require.NoError(t, err)
