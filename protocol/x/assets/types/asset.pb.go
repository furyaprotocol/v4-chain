...
// source: furyaprotocol/assets/asset.proto
...
func init() {
	proto.RegisterType((*Asset)(nil), "furyaprotocol.assets.Asset")
}

func init() { proto.RegisterFile("furyaprotocol/assets/asset.proto", fileDescriptor_d0b73b5c910a62b5) }
