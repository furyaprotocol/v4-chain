...
// source: furyaprotocol/perpetuals/perpetual.proto
...
type Perpetual struct {
	...
	FundingIndex github_com_furyaprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=funding_index,json=fundingIndex,proto3,customtype=github.com/furyanprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"funding_index"`
}
...
func init() {
	proto.RegisterType((*Perpetual)(nil), "furyaprotocol.perpetuals.Perpetual")
	proto.RegisterType((*PerpetualParams)(nil), "furyaprotocol.perpetuals.PerpetualParams")
	proto.RegisterType((*MarketPremiums)(nil), "furyaprotocol.perpetuals.MarketPremiums")
	proto.RegisterType((*PremiumStore)(nil), "furyaprotocol.perpetuals.PremiumStore")
	proto.RegisterType((*LiquidityTier)(nil), "furyaprotocol.perpetuals.LiquidityTier")
}

func init() {
	proto.RegisterFile("furyaprotocol/perpetuals/perpetual.proto", fileDescriptor_ce7204eee10038be)
}
