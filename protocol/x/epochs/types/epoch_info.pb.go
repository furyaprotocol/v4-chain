...
// source: furyaprotocol/epochs/epoch_info.proto
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "furyaprotocol.epochs.EpochInfo")
}

func init() {
	proto.RegisterFile("furyaprotocol/epochs/epoch_info.proto", fileDescriptor_f68fbdc80f51e2c4)
}
