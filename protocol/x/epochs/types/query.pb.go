...
// source: furyaprotocol/epochs/query.proto
...
func init() {
	proto.RegisterType((*QueryGetEpochInfoRequest)(nil), "furyaprotocol.epochs.QueryGetEpochInfoRequest")
	proto.RegisterType((*QueryEpochInfoResponse)(nil), "furyaprotocol.epochs.QueryEpochInfoResponse")
	proto.RegisterType((*QueryAllEpochInfoRequest)(nil), "furyaprotocol.epochs.QueryAllEpochInfoRequest")
	proto.RegisterType((*QueryEpochInfoAllResponse)(nil), "furyaprotocol.epochs.QueryEpochInfoAllResponse")
}

func init() { proto.RegisterFile("furyaprotocol/epochs/query.proto", fileDescriptor_251d1b776a8ec968) }
...
func (c *queryClient) EpochInfo(ctx context.Context, in *QueryGetEpochInfoRequest, opts ...grpc.CallOption) (*QueryEpochInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.epochs.Query/EpochInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EpochInfoAll(ctx context.Context, in *QueryAllEpochInfoRequest, opts ...grpc.CallOption) (*QueryEpochInfoAllResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.epochs.Query/EpochInfoAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EpochInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.epochs.Query/EpochInfo",
	}
...
func _Query_EpochInfoAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.epochs.Query/EpochInfoAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.epochs.Query",
	...
	Metadata: "furyaprotocol/epochs/query.proto",
}
