...
// source: furyaprotocol/delaymsg/query.proto
...
func init() {
	proto.RegisterType((*QueryNextDelayedMessageIdRequest)(nil), "furyaprotocol.delaymsg.QueryNextDelayedMessageIdRequest")
	proto.RegisterType((*QueryNextDelayedMessageIdResponse)(nil), "furyaprotocol.delaymsg.QueryNextDelayedMessageIdResponse")
	proto.RegisterType((*QueryMessageRequest)(nil), "furyaprotocol.delaymsg.QueryMessageRequest")
	proto.RegisterType((*QueryMessageResponse)(nil), "furyaprotocol.delaymsg.QueryMessageResponse")
	proto.RegisterType((*QueryBlockMessageIdsRequest)(nil), "furyaprotocol.delaymsg.QueryBlockMessageIdsRequest")
	proto.RegisterType((*QueryBlockMessageIdsResponse)(nil), "furyaprotocol.delaymsg.QueryBlockMessageIdsResponse")
}

func init() { proto.RegisterFile("furyaprotocol/delaymsg/query.proto", fileDescriptor_60f81d4d7b29defa) }
...
func (c *queryClient) NextDelayedMessageId(ctx context.Context, in *QueryNextDelayedMessageIdRequest, opts ...grpc.CallOption) (*QueryNextDelayedMessageIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.delaymsg.Query/NextDelayedMessageId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Message(ctx context.Context, in *QueryMessageRequest, opts ...grpc.CallOption) (*QueryMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.delaymsg.Query/Message", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) BlockMessageIds(ctx context.Context, in *QueryBlockMessageIdsRequest, opts ...grpc.CallOption) (*QueryBlockMessageIdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.delaymsg.Query/BlockMessageIds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_NextDelayedMessageId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.delaymsg.Query/NextDelayedMessageId",
	}
...
func _Query_Message_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.delaymsg.Query/Message",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_BlockMessageIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.delaymsg.Query/BlockMessageIds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.delaymsg.Query",
	...
	Metadata: "furyaprotocol/delaymsg/query.proto",
}
