...
// source: furyaprotocol/delaymsg/delayed_message.proto
...
func init() {
	proto.RegisterType((*DelayedMessage)(nil), "furyaprotocol.delaymsg.DelayedMessage")
}

func init() {
	proto.RegisterFile("furyaprotocol/delaymsg/delayed_message.proto", fileDescriptor_ff78478f6237d0fe)
}
