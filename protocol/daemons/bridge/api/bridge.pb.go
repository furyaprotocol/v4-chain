...
// source: furyaprotocol/daemons/bridge/bridge.proto
...
import (
	...
	types "github.com/furyanprotocol/v4-chain/protocol/x/bridge/types"
...
func init() {
	proto.RegisterType((*AddBridgeEventsRequest)(nil), "furyaprotocol.daemons.bridge.AddBridgeEventsRequest")
	proto.RegisterType((*AddBridgeEventsResponse)(nil), "furyaprotocol.daemons.bridge.AddBridgeEventsResponse")
}

func init() {
	proto.RegisterFile("furyaprotocol/daemons/bridge/bridge.proto", fileDescriptor_aa0ec72532d69e10)
}
...
func (c *bridgeServiceClient) AddBridgeEvents(ctx context.Context, in *AddBridgeEventsRequest, opts ...grpc.CallOption) (*AddBridgeEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.daemons.bridge.BridgeService/AddBridgeEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BridgeService_AddBridgeEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.daemons.bridge.BridgeService/AddBridgeEvents",
	}
...
var _BridgeService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.daemons.bridge.BridgeService",
	...
	Metadata: "furyaprotocol/daemons/bridge/bridge.proto",
}
