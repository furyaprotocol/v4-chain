...
// source: furyaprotocol/daemons/pricefeed/price_feed.proto
...
func init() {
	proto.RegisterType((*UpdateMarketPricesRequest)(nil), "furyaprotocol.daemons.pricefeed.UpdateMarketPricesRequest")
	proto.RegisterType((*UpdateMarketPricesResponse)(nil), "furyaprotocol.daemons.pricefeed.UpdateMarketPricesResponse")
	proto.RegisterType((*ExchangePrice)(nil), "furyaprotocol.daemons.pricefeed.ExchangePrice")
	proto.RegisterType((*MarketPriceUpdate)(nil), "furyaprotocol.daemons.pricefeed.MarketPriceUpdate")
}

func init() {
	proto.RegisterFile("furyaprotocol/daemons/pricefeed/price_feed.proto", fileDescriptor_3d8cd2726a0e97cb)
}
...
func (c *priceFeedServiceClient) UpdateMarketPrices(ctx context.Context, in *UpdateMarketPricesRequest, opts ...grpc.CallOption) (*UpdateMarketPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.daemons.pricefeed.PriceFeedService/UpdateMarketPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PriceFeedService_UpdateMarketPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.daemons.pricefeed.PriceFeedService/UpdateMarketPrices",
	}
...
var _PriceFeedService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.daemons.pricefeed.PriceFeedService",
	...
	Metadata: "furyaprotocol/daemons/pricefeed/price_feed.proto",
}
