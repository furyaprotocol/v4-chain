...
// source: furyaprotocol/daemons/liquidation/liquidation.proto
...
import (
	...
	types1 "github.com/furyanprotocol/v4-chain/protocol/x/clob/types"
...
func init() {
	proto.RegisterType((*LiquidateSubaccountsRequest)(nil), "furyaprotocol.daemons.liquidation.LiquidateSubaccountsRequest")
	proto.RegisterType((*LiquidateSubaccountsResponse)(nil), "furyaprotocol.daemons.liquidation.LiquidateSubaccountsResponse")
}

func init() {
	proto.RegisterFile("furyaprotocol/daemons/liquidation/liquidation.proto", fileDescriptor_66068592911cfa5a)
}
...
func (c *liquidationServiceClient) LiquidateSubaccounts(ctx context.Context, in *LiquidateSubaccountsRequest, opts ...grpc.CallOption) (*LiquidateSubaccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyaprotocol.daemons.liquidation.LiquidationService/LiquidateSubaccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LiquidationService_LiquidateSubaccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyaprotocol.daemons.liquidation.LiquidationService/LiquidateSubaccounts",
	}
...
var _LiquidationService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyaprotocol.daemons.liquidation.LiquidationService",
	...
	Metadata: "furyaprotocol/daemons/liquidation/liquidation.proto",
}
