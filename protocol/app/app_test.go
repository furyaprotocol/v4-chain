...
import (
	...
	custommodule "github.com/furyanprotocol/v4-chain/protocol/app/module"
...
func TestClobKeeperMemStoreHasBeenInitialized(t *testing.T) {
	...
	ctx := furyaApp.NewUncachedContext(true, tmproto.Header{})

	// The memstore panics if initialized twice so initializing again outside of application
	// start-up should cause a panic.
	require.Panics(t, func() { furyaApp.ClobKeeper.InitMemStore(ctx) })
}

func TestBaseApp(t *testing.T) {
	furyaApp := testapp.DefaultTestApp(nil)
	require.NotNil(t, furyaApp.GetBaseApp(), "Expected non-nil BaseApp")
}

func TestLegacyAmino(t *testing.T) {
	furyaApp := testapp.DefaultTestApp(nil)
	require.NotNil(t, furyaApp.LegacyAmino(), "Expected non-nil LegacyAmino")
}

func TestAppCodec(t *testing.T) {
	furyaApp := testapp.DefaultTestApp(nil)
	require.NotNil(t, furyaApp.AppCodec(), "Expected non-nil AppCodec")
}

func TestInterfaceRegistry(t *testing.T) {
	furyaApp := testapp.DefaultTestApp(nil)
	require.NotNil(t, furyaApp.InterfaceRegistry(), "Expected non-nil InterfaceRegistry")
}

func TestTxConfig(t *testing.T) {
	furyaApp := testapp.DefaultTestApp(nil)
	require.NotNil(t, furyaApp.TxConfig(), "Expected non-nil TxConfig")
}

func TestDefaultGenesis(t *testing.T) {
	furyaApp := testapp.DefaultTestApp(nil)
	require.NotNil(t, furyaApp.DefaultGenesis(), "Expected non-nil DefaultGenesis")
}

func TestSimulationManager(t *testing.T) {
	furyaApp := testapp.DefaultTestApp(nil)
	require.Nil(t, furyaApp.SimulationManager(), "Expected nil SimulationManager")
}
