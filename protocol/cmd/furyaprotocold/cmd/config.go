...
func initAppConfig() (string, *FuryaAppConfig) {
...
func initTendermintConfig() *tmcfg.Config {
	...
	// (https://github.com/furyaprotocol/tendermint/blob/dc03b21cf5d54c641e1d14b14fae5920fa7ba656/config/config.go#L982)
