...
// source: furyaprotocol/indexer/off_chain_updates/off_chain_updates.proto
...
type OrderPlaceV1 struct {
	...
	PlacementStatus OrderPlaceV1_OrderPlacementStatus `protobuf:"varint,2,opt,name=placement_status,json=placementStatus,proto3,enum=furyaprotocol.indexer.off_chain_updates.OrderPlaceV1_OrderPlacementStatus" json:"placement_status,omitempty"`
}
...
type OrderRemoveV1 struct {
	...
	RemovalStatus  OrderRemoveV1_OrderRemovalStatus `protobuf:"varint,3,opt,name=removal_status,json=removalStatus,proto3,enum=furyaprotocol.indexer.off_chain_updates.OrderRemoveV1_OrderRemovalStatus" json:"removal_status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("furyaprotocol.indexer.off_chain_updates.OrderPlaceV1_OrderPlacementStatus", OrderPlaceV1_OrderPlacementStatus_name, OrderPlaceV1_OrderPlacementStatus_value)
	proto.RegisterEnum("furyaprotocol.indexer.off_chain_updates.OrderRemoveV1_OrderRemovalStatus", OrderRemoveV1_OrderRemovalStatus_name, OrderRemoveV1_OrderRemovalStatus_value)
	proto.RegisterType((*OrderPlaceV1)(nil), "furyaprotocol.indexer.off_chain_updates.OrderPlaceV1")
	proto.RegisterType((*OrderRemoveV1)(nil), "furyaprotocol.indexer.off_chain_updates.OrderRemoveV1")
	proto.RegisterType((*OrderUpdateV1)(nil), "furyaprotocol.indexer.off_chain_updates.OrderUpdateV1")
	proto.RegisterType((*OffChainUpdateV1)(nil), "furyaprotocol.indexer.off_chain_updates.OffChainUpdateV1")
}

func init() {
	proto.RegisterFile("furyaprotocol/indexer/off_chain_updates/off_chain_updates.proto", fileDescriptor_a3058c1b66f59e98)
}
