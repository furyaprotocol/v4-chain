...
// source: furyaprotocol/indexer/indexer_manager/event.proto
...
type IndexerTendermintEvent_BlockEvent_ struct {
	BlockEvent IndexerTendermintEvent_BlockEvent `protobuf:"varint,4,opt,name=block_event,json=blockEvent,proto3,enum=furyaprotocol.indexer.indexer_manager.IndexerTendermintEvent_BlockEvent,oneof" json:"block_event,omitempty"`
}
...
func init() {
	proto.RegisterEnum("furyaprotocol.indexer.indexer_manager.IndexerTendermintEvent_BlockEvent", IndexerTendermintEvent_BlockEvent_name, IndexerTendermintEvent_BlockEvent_value)
	proto.RegisterType((*IndexerTendermintEventWrapper)(nil), "furyaprotocol.indexer.indexer_manager.IndexerTendermintEventWrapper")
	proto.RegisterType((*IndexerEventsStoreValue)(nil), "furyaprotocol.indexer.indexer_manager.IndexerEventsStoreValue")
	proto.RegisterType((*IndexerTendermintEvent)(nil), "furyaprotocol.indexer.indexer_manager.IndexerTendermintEvent")
	proto.RegisterType((*IndexerTendermintBlock)(nil), "furyaprotocol.indexer.indexer_manager.IndexerTendermintBlock")
}

func init() {
	proto.RegisterFile("furyaprotocol/indexer/indexer_manager/event.proto", fileDescriptor_18a6a94c31da6b1f)
}
