...
// source: furyaprotocol/indexer/protocol/v1/subaccount.proto
...
type IndexerPerpetualPosition struct {
	...
	Quantums github_com_furyaprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=quantums,proto3,customtype=github.com/furyanprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"quantums"`
	...
	FundingPayment github_com_furyaprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=funding_payment,json=fundingPayment,proto3,customtype=github.com/furyanprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"funding_payment"`
}
...
func init() {
	proto.RegisterType((*IndexerSubaccountId)(nil), "furyaprotocol.indexer.protocol.v1.IndexerSubaccountId")
	proto.RegisterType((*IndexerPerpetualPosition)(nil), "furyaprotocol.indexer.protocol.v1.IndexerPerpetualPosition")
	proto.RegisterType((*IndexerAssetPosition)(nil), "furyaprotocol.indexer.protocol.v1.IndexerAssetPosition")
}

func init() {
	proto.RegisterFile("furyaprotocol/indexer/protocol/v1/subaccount.proto", fileDescriptor_4c5845963309ad8f)
}
