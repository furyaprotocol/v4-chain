...
// source: furyaprotocol/indexer/common/common.proto
...
func init() {
	proto.RegisterEnum("furyaprotocol.indexer.common.OrderRemovalReason", OrderRemovalReason_name, OrderRemovalReason_value)
}

func init() {
	proto.RegisterFile("furyaprotocol/indexer/common/common.proto", fileDescriptor_cc7f22a39c006b65)
}
