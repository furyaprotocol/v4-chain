...
// source: furyaprotocol/indexer/shared/removal_reason.proto
...
func init() {
	proto.RegisterEnum("furyaprotocol.indexer.shared.OrderRemovalReason", OrderRemovalReason_name, OrderRemovalReason_value)
}

func init() {
	proto.RegisterFile("furyaprotocol/indexer/shared/removal_reason.proto", fileDescriptor_0d5eea5cab8c58ba)
}
